...
@class NSString, TFNDirectMessageConversation, TFNDirectMessageConversationIdentifier, TFNDirectMessageCryptographyService;
...
- (id)initWithConversation:(id)arg1 cryptographyService:(id)arg2;
