...
{
    _Bool _directlyTypedResultEnabled;
...
@property(nonatomic, getter=isDirectlyTypedResultEnabled) _Bool directlyTypedResultEnabled; // @synthesize directlyTypedResultEnabled=_directlyTypedResultEnabled;
@property(nonatomic) __weak id <T1UserTypeaheadViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)_t1_didSelectUsernameItem;
