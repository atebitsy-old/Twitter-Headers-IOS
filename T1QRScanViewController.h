...
@interface T1QRScanViewController : TFNViewController <AVCaptureMetadataOutputObjectsDelegate, T1ModalViewControllerNonModalPresentationDelegate, T1TwitterAuthenticated, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
{
