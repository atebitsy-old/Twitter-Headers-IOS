...
@interface T1PhotoMediaRailViewController : TFNViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UICollectionViewDelegate, PHPhotoLibraryChangeObserver, T1NativeCameraViewControllerDelegate, T1CameraContainerViewControllerDelegate, T1NewsCameraCaptureViewControllerDelegate, T1VideoTrimmerViewControllerDelegate, T1PhotoCachingImageManagerHelperDelegate, T1TwitterAuthenticated>
{
    _Bool _authorized;
    _Bool _cameraButtonHidden;
    _Bool _newsCameraButtonHidden;
    _Bool _newsCameraButtonEnabled;
...
@property(nonatomic, getter=isNewsCameraButtonEnabled) _Bool newsCameraButtonEnabled; // @synthesize newsCameraButtonEnabled=_newsCameraButtonEnabled;
@property(nonatomic, getter=isNewsCameraButtonHidden) _Bool newsCameraButtonHidden; // @synthesize newsCameraButtonHidden=_newsCameraButtonHidden;
...
- (void)_t1_presentNewsCameraViewController;
