...
@class NSArray, NSMutableArray, NSString, T1OnboardingSubtaskController, T1PromptImageSpec, T1PromptTextSpec, TFNOnboardingHeaderImage, TFNOnboardingRichText, TFNTwitterAccount, UIImage;
