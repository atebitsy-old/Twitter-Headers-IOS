...
@interface T1QuotedStatusViewLayoutState : NSObject <T1SocialContextLayoutState, T1ConversationContextLayoutState>
{
    ...
    struct CGRect _expandActionLabelFrame;
...
@property(nonatomic) struct CGRect expandActionLabelFrame; // @synthesize expandActionLabelFrame=_expandActionLabelFrame;
