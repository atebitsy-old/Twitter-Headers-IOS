...
@class NSHashTable, NSMapTable, NSMutableDictionary, NSString, TFNTwitterFeatureSwitchesAATest, TFNTwitterFeatureSwitchesHostBridgeScribeDelegate, TLTBackgroundTaskManager;
