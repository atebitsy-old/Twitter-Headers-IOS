...
@interface T1ComposeController : NSObject <T1CameraContainerViewControllerDelegate, T1NativeCameraViewControllerDelegate, T1TweetComposeContainerViewControllerDelegate>
{
