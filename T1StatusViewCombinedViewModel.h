...
- (_Bool)isNonPolicyCompliantTweet;
@property(readonly, nonatomic) _Bool isContentHidden;
...
- (id)init;
- (id)initWithStatusViewModel:(id)arg1 options:(unsigned long long)arg2 account:(id)arg3;
