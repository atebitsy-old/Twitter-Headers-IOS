...
@interface T1OnboardingPresenter : NSObject <UIViewControllerTransitioningDelegate>
{
    ...
    NSString *_topViewControllerSubtaskID;
}

@property(readonly, nonatomic) NSString *topViewControllerSubtaskID; // @synthesize topViewControllerSubtaskID=_topViewControllerSubtaskID;
...
- (id)pushViewController:(id)arg1 withPresentationType:(long long)arg2 hideBackButton:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
