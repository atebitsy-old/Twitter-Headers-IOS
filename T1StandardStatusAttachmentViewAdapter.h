...
#import <T1Twitter/T1StatusViewAttachmentContainerViewPrefetchingDelegate-Protocol.h>

@class NSString, TFSTwitterScribeContext, UIView;
@protocol T1AutoplayViewContainer, T1BasicStatusView, T1StatusViewInlineImages;

@interface T1StandardStatusAttachmentViewAdapter : TFNComposableViewAdapter <T1StatusViewAttachmentContainerViewDelegate, T1StatusViewAttachmentContainerViewPrefetchingDelegate, T1StatusEmbeddedCarouselHost>
{
    CDUnknownBlockType _embeddedCarouselCreationBlock;
    TFNComposableViewAdapter *_newsCameraOverlayViewAdapter;
...
@property(retain, nonatomic) TFNComposableViewAdapter *newsCameraOverlayViewAdapter; // @synthesize newsCameraOverlayViewAdapter=_newsCameraOverlayViewAdapter;
- (void).cxx_destruct;
...
- (id)attachmentContainerView:(id)arg1 previewingViewControllerForLocation:(struct CGPoint)arg2 outSourceRect:(out struct CGRect *)arg3;
...
- (id)_t1_collectionCarouselLayoutStateForViewModel:(id)arg1 layoutMetrics:(id)arg2;
...
- (_Bool)_t1_useAdaptiveMediaLayoutForViewModel:(id)arg1 attachmentType:(unsigned long long)arg2;
...
- (_Bool)_t1_shouldRenderEmbeddedCarousel;
