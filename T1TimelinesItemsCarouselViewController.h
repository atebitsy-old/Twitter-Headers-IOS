...
@class NSIndexPath, NSMutableDictionary, NSString, T1TimelinesCarouselCollectionViewLayout, T1TimelinesItemsCarouselScrollObserver, T1TimelinesItemsCarouselViewControllerScribeHelper, TFNTwitterAccount, TFSTwitterScribeContext;
...
@interface T1TimelinesItemsCarouselViewController : TFNItemsDataViewController <TFNDelegateContentVisibility, T1TimelinesItemsCarouselItemsContextProvider, T1TimelinesItemsCarouselScrollObserverDelegate, T1TimelinesHostedViewController>
{
    ...
    NSIndexPath *_initialIndexPathToFocus;
...
@property(retain, nonatomic) NSIndexPath *initialIndexPathToFocus; // @synthesize initialIndexPathToFocus=_initialIndexPathToFocus;
