...
@class NSArray, NSString, T1DirectMessageParticipantValidator, T1DirectMessageSearchQueryView, T1DirectMessageTypeaheadDataSource, T1DirectMessageUserPickerViewControllerSelectionBehavior, TFNBarButtonItem, TFNTwitterAccount;
