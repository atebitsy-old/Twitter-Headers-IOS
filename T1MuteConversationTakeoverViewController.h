...
@class NSArray, NSString, T1PromptImageSpec, T1PromptTextSpec, TFNTwitterAccount, TFSTwitterScribeContext, UIImage;

@interface T1MuteConversationTakeoverViewController : T1PromptViewController <T1PromptDataSource, T1TwitterAuthenticated>
{
