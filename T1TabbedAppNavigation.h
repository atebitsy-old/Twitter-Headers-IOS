...
@class NSArray, NSMutableArray, NSString, T1ComposeController, T1DashSplitViewController, T1DirectMessageParticipantValidator, T1DockingController, T1FoundMediaPresentationContext, T1OnboardingFlowController, T1PhotoGalleryPresentationContext, TFNHUD, TFNTwitterAccount, TFNTwitterStatus, UIViewController;
@protocol T1TabbedAppNavigationDelegate, TFNNavigationStack, TFSTwitterLegacyScribeLogMethods;

@interface T1TabbedAppNavigation : NSObject <T1OnboardingFlowControllerDelegate, T1ComposeControllerDelegate, T1TweetDraftsViewControllerDelegate, T1AppNavigation>
{
...
@property(readonly, nonatomic) T1DashSplitViewController *dashSplitViewController;
