...
@protocol TFNTwitterFooterViewModel><TFSTwitterTimelinePlistSerialization, TFNTwitterTimelineItemsHydrationScriber;

@interface TFNTwitterSuggestsModule : NSObject <TFSDateComparable, TFSTwitterTimelinePlistSerialization, TFNTwitterMutableDismissibleItem, TFNTwitterFeedbackInfoSource, TFNTwitterTimelineObject>
{
    _Bool _dismissing;
...
- (id)initWithJSONDictionary:(id)arg1 statusesDictionary:(id)arg2 comparableDate:(id)arg3 legacyIntegrationEnabled:(_Bool)arg4 scriber:(id)arg5;
