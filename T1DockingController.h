...
@class NSString, T1DockingVisibilityController, T1TwitterTooltip, TFNFloatingView, TFNInterfaceOrientationChangeListener, TFNTwitterAccount, TFNViewController, UIImpactFeedbackGenerator, UINotificationFeedbackGenerator, UISelectionFeedbackGenerator, UIView, UIWindow;
