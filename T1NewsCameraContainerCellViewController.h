...
@interface T1NewsCameraContainerCellViewController : TFNViewController <UIScrollViewDelegate, T1NewsCameraCapsuleViewControllerDelegate, T1TweetDetailsViewControllerDelegate, UIGestureRecognizerDelegate>
{
    ...
    unsigned long long _totalStatusCount;
...
@property(nonatomic) unsigned long long totalStatusCount; // @synthesize totalStatusCount=_totalStatusCount;
...
- (void)capsuleViewControllerShouldNavigateToPreviousTweetIfPossible:(id)arg1;
- (void)capsuleViewControllerShouldNavigateToNextTweetIfPossible:(id)arg1;
