...
@property(retain, nonatomic) NSArray *collectionCardDataItems; // @synthesize collectionCardDataItems=_collectionCardDataItems;
...
@property(readonly, nonatomic) NSString *composerSource; // @synthesize composerSource=_composerSource;
...
- (id)initWithCS2Status:(id)arg1 fromUser:(id)arg2;
- (id)initWithStatusID:(long long)arg1 originalText:(id)arg2 fromUser:(id)arg3 inReplyToStatusID:(long long)arg4 inReplyToUserID:(long long)arg5 inReplyToUsername:(id)arg6 selfThreadID:(long long)arg7;
...
@property(readonly, nonatomic) NSData *serializedGeotagData;
