...
@interface T1UnifiedCardSwipeableMediaComponentViewLayoutState : NSObject <T1UnifiedCardComponentViewLayoutState>
{
...
- (void).cxx_destruct;
- (id)initWithSwipeableMediaComponent:(id)arg1 size:(struct CGSize)arg2 layoutMetrics:(id)arg3;
