...
@class NSString, TFNOnboardingChoiceSelectionSubtask, TFNOnboardingChoiceSelectionSubtaskState;
...
{
    TFNOnboardingChoiceSelectionSubtask *_subtask;
    id <T1OnboardingSubtaskControllerDelegate> _delegate;
    TFNOnboardingChoiceSelectionSubtaskState *_state;
}
