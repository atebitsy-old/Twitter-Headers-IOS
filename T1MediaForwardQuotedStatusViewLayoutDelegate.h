...
- (double)_t1_layoutTweetstormIndicator:(id)arg1 forViewModel:(id)arg2 options:(unsigned long long)arg3 account:(id)arg4 layoutMetrics:(id)arg5 contentX:(double)arg6 contentWidth:(double)arg7 contentY:(double)arg8 shouldShowIndicator:(_Bool)arg9 shouldShowMedia:(_Bool)arg10;
