...
@interface TFNOnboardingSettingsValueListData : NSObject <TFNOnboardingSettingsValueDictionaryTranslatable>
{
...
- (id)copy;
- (id)initWithAllowedValues:(id)arg1 isSearchEnabled:(_Bool)arg2;
