...
@class NSString, T1AffiliateBadgeView, T1AvatarImageView, T1DismissButton, T1InfoTextView, T1StatusReplyBadgeView, T1TimelinesItemSocialContextView, T1UserBadger, T1UserBannerImageView, TFNAttributedTextView, TFNFollowsYouView, TFNSizeThatFitsHelper, TFNTappableHighlightView, TFNTwitterAccount, TFSTwitterScribeContext, UIColor, UIFont, UIImageView, UILabel, UILongPressGestureRecognizer, UITapGestureRecognizer;
