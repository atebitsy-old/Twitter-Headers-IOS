...
- (_Bool)dynamicAdEnabledInStatus:(id)arg1 allowPrerollVideoAdsFromTimelineResponse:(_Bool)arg2;
- (id)dynamicAdEnabledStatusesFromStatuses:(id)arg1 allowPrerollVideoAdsFromTimelineResponse:(_Bool)arg2;
