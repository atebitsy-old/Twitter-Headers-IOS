...
@property(nonatomic) _Bool hasAllocatedWidth; // @synthesize hasAllocatedWidth=_hasAllocatedWidth;
@property(nonatomic) double allocatedWidth; // @synthesize allocatedWidth=_allocatedWidth;
@property(nonatomic) double heightAboveBaselineIfUncentered; // @synthesize heightAboveBaselineIfUncentered=_heightAboveBaselineIfUncentered;
