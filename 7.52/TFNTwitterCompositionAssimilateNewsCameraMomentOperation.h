...
@interface TFNTwitterCompositionAssimilateNewsCameraMomentOperation : TFSDependentConcurrentOperation <TFNTwitterCompositionUpdateStatusDependency>
{
...
- (void).cxx_destruct;
- (void)_tfn_main_replaceMomentID;
- (void)_tfn_main_updateLatestNewsCameraMoment;
- (void)_tfn_main_run;
- (void)run;
