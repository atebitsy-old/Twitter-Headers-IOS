...
{
    _Bool _needsToRequestAuthorizations;
    _Bool _needsToRegrantAuthorizations;
...
@property(nonatomic) _Bool needsToRegrantAuthorizations; // @synthesize needsToRegrantAuthorizations=_needsToRegrantAuthorizations;
@property(nonatomic) _Bool needsToRequestAuthorizations; // @synthesize needsToRequestAuthorizations=_needsToRequestAuthorizations;
