...
@class NSString, T1SearchBarView, T1UserTypeaheadViewController, TFNItemsDataViewAdapter, TFNTwitterList, TFNTwitterUserListMembersList, UIView;

@interface T1ListMembersViewController : T1UsersViewController <UITextFieldDelegate, T1UserTypeaheadViewControllerDelegate, UITextViewDelegate>
{
    _Bool _isNewList;
    _Bool _allowRemove;
...
@property(retain, nonatomic) T1UserTypeaheadViewController *typeaheadViewController; // @synthesize typeaheadViewController=_typeaheadViewController;
