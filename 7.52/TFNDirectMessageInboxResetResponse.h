...
@class NSNumber, NSString, TFNDirectMessageEntriesResponse, TFNDirectMessageKeyRegistryState, TFNDirectMessageTimelineCursor;
...
@interface TFNDirectMessageInboxResetResponse : NSObject
{
    ...
    TFNDirectMessageKeyRegistryState *_keyRegistryState;
}

@property(readonly, nonatomic) TFNDirectMessageKeyRegistryState *keyRegistryState; // @synthesize keyRegistryState=_keyRegistryState;
...
- (id)initWithEntriesResponse:(id)arg1 cursor:(id)arg2 lastSeenEventID:(id)arg3 trustedLastSeenEventID:(id)arg4 untrustedLastSeenEventID:(id)arg5 trustedConversationsTimelineCursor:(id)arg6 untrustedConversationsTimelineCursor:(id)arg7 keyRegistryState:(id)arg8;
- (id)init;
