...
@class NSArray, NSString, T1ScrollingSegmentedViewController, T1SearchFeatures, T1SearchFiltersViewController, T1SearchResultsParameters, T1SearchTextView, T1SearchTypeaheadViewController, T1SearchViewContainerView, T1URTGenericViewControllerCollection, TFNTwitterAccount, TFSTwitterScribeContext, UIViewController;
...
@interface T1SearchContainerViewController : TFNViewController <UITextFieldDelegate, T1URTGenericViewControllerCollectionDelegate, T1SearchTypeaheadViewControllerDelegate, T1SearchFiltersViewControllerDelegate, T1ViewControllerPerformanceTesting, T1SearchTextViewDelegate, TFNTooltipDelegate, TFNTwitterCompositionSource, TFNLayoutMetricsEnvironment, T1JumpBackToHomeTimelineBehavior>
{
    ...
    T1ScrollingSegmentedViewController *_searchResultsViewController;
...
@property(nonatomic) _Bool qualityFilterEnabled; // @synthesize qualityFilterEnabled=_qualityFilterEnabled;
...
@property(copy, nonatomic) NSArray *tabEntries; // @synthesize tabEntries=_tabEntries;
...
@property(retain, nonatomic) T1ScrollingSegmentedViewController *searchResultsViewController; // @synthesize searchResultsViewController=_searchResultsViewController;
...
- (void)_t1_performSearchWithFollowingFilterEnabled:(_Bool)arg1 locationFilterEnabled:(_Bool)arg2 qualityFilterEnabled:(_Bool)arg3;
