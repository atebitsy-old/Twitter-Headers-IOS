...
@class NSMutableDictionary, NSMutableSet, NSString, T1NewsCameraAnimatedPresenter, T1StatusLiveEngagementManager, T1StatusMediaHandler, T1StatusMediaTimelineObserver, T1StatusPromotedImpressionHandler, T1StatusTableSlideshowManager, TFNCellPreparationTimePerformanceMetric, TFNDataViewController, TFNTwitterAccount, TFNTwitterDisplaySessionManager;
...
- (id)_t1_prefetchingOperationWithBlock:(CDUnknownBlockType)arg1 scribe:(id)arg2 scribeContext:(id)arg3;
...
- (id)init;
- (id)initWithAccount:(id)arg1 forAllInstancesInTableViewController:(id)arg2;
- (id)initWithAccount:(id)arg1;
- (void)_t1_configureForTweetDetailsController:(id)arg1 account:(id)arg2 itemsAlwaysAllowingMute:(id)arg3;
