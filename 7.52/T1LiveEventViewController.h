...
@class NSArray, NSDictionary, NSError, NSLayoutConstraint, NSNumber, NSString, T1EmptyContentViewController, T1LiveEventCarouselSubheaderViewController, T1LiveEventCarouselTransitionHandler, T1LiveEventHeaderCarouselEntryViewController, T1LiveEventHeaderViewController, T1LiveEventLoadingView, T1LiveEventMediaViewController, T1LiveEventMetadataSubheaderViewController, T1LiveEventPlayerStateController, T1LiveEventScoreSubheaderViewController, T1LiveEventViewControllerScrollingHandler, T1MediaInlineComposeController, T1SlideshowViewController, T1StreamPoller, TFNTwitterLiveEvent, TFNTwitterLiveEventCarouselEntry, TFNTwitterLiveEventTimelineStreamLoader, TFNTwitterLiveEventTimelineVariant, TFNTwitterRichTimelineStream, TFSTimer, TFSTwitterScribeContext, UIView, UIVisualEffectView;
@protocol TFNTwitterCardDataSource;

@interface T1LiveEventViewController : T1ResizableHeaderContainerViewController <T1ResizableHeaderContentDelegate, T1LiveEventPlayerStateControllerDelegate, TFNTwitterLiveEventTimelineStreamLoaderDelegate, T1MediaInlineComposeControllerDelegate, T1LiveEventMetadataSubheaderViewControllerDelegate, T1DockingControllerDelegate, T1LiveEventViewControllerScrollingHandlerDelegate, T1ImageTransitionDelegate, T1SlideshowViewControllerDelegate, T1UpdateIndicatorDelegate, T1LiveEventCarouselSubheaderViewControllerDelegate, T1WatchBroadcastViewControllerDelegate, T1LiveEventCarouselTransitionObserver, T1LiveEventHeaderCarouselEntryViewControllerDelegate, T1LiveEventHeaderViewControllerScribeDataSource, T1LiveEventHeaderViewControllerDelegate, T1ComposeCustomAction, TFNTwitterDockable>
{
...
- (void)_t1_updateScoreSubheaderViewControllerWithTopModule:(id)arg1 accountID:(id)arg2;
