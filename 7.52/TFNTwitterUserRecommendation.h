...
@class NSArray, NSDictionary, NSString, TFNTwitterPromotedContent, TFNTwitterUser, TFNTwitterUserWhyToFollow;

@interface TFNTwitterUserRecommendation : NSObject <T1PeopleDiscoveryScribableItem, TFSTwitterScribableItem, TFSPlistSerialization, TFSTwitterTimelinePlistSerialization, TFNTwitterUserContext>
{
