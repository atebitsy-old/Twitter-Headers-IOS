...
- (void)updateTweetTextState:(_Bool)arg1 inViewModel:(id)arg2 withAccount:(id)arg3;
...
- (double)layoutExpandActionView:(id)arg1 forViewModel:(id)arg2 options:(unsigned long long)arg3 account:(id)arg4 contentX:(double)arg5 contentY:(double)arg6 maxContentWidth:(double)arg7 maxWidth:(double)arg8;
...
- (double)layoutTextFirstAnatomy:(id)arg1 forViewModel:(id)arg2 options:(unsigned long long)arg3 account:(id)arg4 attachmentType:(unsigned long long)arg5 layoutMetrics:(id)arg6 contentX:(double)arg7 contentY:(double)arg8 contentWidth:(double)arg9 maxContentHeight:(double)arg10 allowHorizontalPadding:(_Bool)arg11 isTextTruncated:(out _Bool *)arg12;
