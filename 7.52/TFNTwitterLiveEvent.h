...
@class NSArray, NSString, TFNTwitterEntityImageInfo, TFNTwitterLiveEventRemindMeSubscription, TFNTwitterLiveEventSponsorshipDetails, TFNTwitterUser, TFSTwitterRect;

@interface TFNTwitterLiveEvent : NSObject <NSCopying>
{
    _Bool _sensitive;
    NSString *_eventID;
