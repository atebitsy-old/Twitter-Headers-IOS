...
@interface TFNTwitterComposition : NSObject <TFNTwitterTweetTextCounterContext, NSCoding>
{
...
@property(copy, nonatomic) NSString *localCameraMomentID; // @synthesize localCameraMomentID=_localCameraMomentID;
...
- (id)_tfn_updatedScribeParameters:(id)arg1 withItemType:(long long)arg2 statusID:(id)arg3;
- (void)scribeSendWithScribe:(id)arg1;
- (id)_tfn_scribeParameterForTweet;
- (id)_tfn_scribeParameterForMedia;
