...
- (void)didExpandOnQuotedStatusView:(T1QuotedStatusView *)arg1;
- (void)didTapActionOnTombstoneView:(T1TombstoneView *)arg1;
- (id)quotedStatusView:(T1QuotedStatusView *)arg1 didSendEvent:(T1StatusViewEvent *)arg2;
...
@optional
- (UIViewController *)attachmentContainerView:(T1StatusViewAttachmentContainerView *)arg1 previewingViewControllerForLocation:(struct CGPoint)arg2 outSourceRect:(out struct CGRect *)arg3;
@end
