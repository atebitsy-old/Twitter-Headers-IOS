...
- (void)removeOverrideForKey:(NSString *)arg1 employeeBuildOrOverrideEnabledAccount:(TFNTwitterAccount *)arg2;
- (void)overrideAllValuesInDictionary:(NSDictionary *)arg1 employeeBuildOrOverrideEnabledAccount:(TFNTwitterAccount *)arg2;
- (void)overrideRawValue:(id)arg1 forKey:(NSString *)arg2 employeeBuildOrOverrideEnabledAccount:(TFNTwitterAccount *)arg3;
