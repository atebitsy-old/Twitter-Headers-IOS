...
@protocol T1LiveEventCarouselCellsRowAdapterDelegate, TFSTwitterLegacyScribeLogMethods;
...
- (id)init;
- (id)initWithImagePipeline:(id)arg1 scribe:(id)arg2 impressionLogger:(id)arg3;
