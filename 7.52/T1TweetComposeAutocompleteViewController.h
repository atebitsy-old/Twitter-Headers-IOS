...
@interface T1TweetComposeAutocompleteViewController : TFNViewController <UISearchBarDelegate, T1ComposeTypeaheadViewControllerDelegate, T1TwitterAuthenticated>
{
