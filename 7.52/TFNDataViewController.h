...
#import <TFNUI/UICollectionViewDataSourcePrefetching-Protocol.h>
#import <TFNUI/UICollectionViewDelegate-Protocol.h>
#import <TFNUI/UITableViewDataSource-Protocol.h>
#import <TFNUI/UITableViewDataSourcePrefetching-Protocol.h>
...
@class NSDictionary, NSMutableSet, NSNumber, NSString, TFNCollectionView, TFNDisplayLink, TFNEstimatedRowHeightTableViewDelegateProxy, TFNFloatingViewAwarePreviewingDelegate, TFNScrollViewDelegateBroadcaster, TFNTableView, TFSTimer, UICollectionViewLayout, UIControl, UIScrollView, UIViewController;
@protocol TFNDataView, TFNPullToLoadTopControl, UIViewControllerPreviewing;

@interface TFNDataViewController : TFNViewController <UICollectionViewDataSource, UICollectionViewDataSourcePrefetching, UICollectionViewDelegate, UITableViewDataSource, UITableViewDataSourcePrefetching, UITableViewDelegate, UIViewControllerPreviewingDelegate, TFNDataSourceScrollPositionAssociation, TFNLayoutMetricsEnvironment, TFNProgrammaticScrollViewDelegate, UITableViewDragDelegate>
{
    _Bool _needsUpdate;
    _Bool _needsReload;
...
- (void).cxx_destruct;
- (id)tfs_debugStrings;
- (_Bool)_tfn_canHandleScrollDownKeyCommands;
- (void)handlePageDownKeyCommand;
- (void)handleLineDownKeyCommand;
- (_Bool)_tfn_canHandleScrollUpKeyCommands;
