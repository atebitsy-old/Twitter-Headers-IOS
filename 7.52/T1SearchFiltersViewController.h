...
@interface T1SearchFiltersViewController : TFNItemsDataViewController
{
    ...
    TFNBooleanItem *_qualityFilterEnabledItem;
}

@property(retain, nonatomic) TFNBooleanItem *qualityFilterEnabledItem; // @synthesize qualityFilterEnabledItem=_qualityFilterEnabledItem;
