...
@protocol T1AutoplayFullscreenCoordinator, T1BasicStatusView, T1SlideshowViewControllerDelegate, TFNDataViewCell, TFNTwitterCardDataSource, TFNTwitterCardEventLogger, TFNTwitterCardScribeContextProvider;
...
- (id)initWithCardContext:(id)arg1 scribeContextProvider:(id)arg2 logger:(id)arg3 presentingViewController:(id)arg4 slideshowDelegate:(id)arg5 mediaHandler:(id)arg6 slideshowManager:(id)arg7 photoIndexNumber:(id)arg8;
