...
@interface _TtC9T1Twitter31URTTimelinePlaceDataViewAdapter : TFNItemsDataViewAdapter
{
    // Error parsing type: , name: sizingCell
    // Error parsing type: , name: infoViewToViewModelMap
    // Error parsing type: , name: mapImageGenerator
}
