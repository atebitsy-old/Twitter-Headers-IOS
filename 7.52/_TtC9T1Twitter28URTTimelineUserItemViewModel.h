...
@class NSDictionary, NSString, TFNTwitterPromotedContent, TFSTwitterEntityMedia, TFSTwitterRelationship, TFSTwitterUserReference;
@protocol T1TwitterSocialContext, TFNTwitterTimelineEntryContext, TFSTwitterCanonicalUser;

__attribute__((visibility("hidden")))
@interface _TtC9T1Twitter28URTTimelineUserItemViewModel : NSObject
{
    ...
    // Error parsing type: , name: promotedContent.storage
    // Error parsing type: , name: bioDisplayTextResult.storage
}
...
- (_Bool)isPromoted;
@property(nonatomic, retain) TFNTwitterPromotedContent *promotedContent;
