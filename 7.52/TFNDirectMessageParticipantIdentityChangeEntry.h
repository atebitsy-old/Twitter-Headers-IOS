...
#import <T1Twitter/TFNDirectMessageParticipantIdentityChangeEntry-Protocol.h>
...
@interface TFNDirectMessageParticipantIdentityChangeEntry : TFNDirectMessageConversationEntry <TFNDirectMessageParticipantIdentityChangeEntry>
{
}
