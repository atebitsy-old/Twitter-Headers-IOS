...
#import <T1Twitter/T1DashNewsCameraPresented-Protocol.h>
#import <T1Twitter/T1NewsCameraAccountGeoDataProviderUpdaterDelegate-Protocol.h>
#import <T1Twitter/T1NewsCameraEventHashtagsFetcherDelegate-Protocol.h>
#import <T1Twitter/T1NewsCameraModeSelectorViewControllerDelegate-Protocol.h>
#import <T1Twitter/T1NewsCameraOutboxControlButtonViewControllerDelegate-Protocol.h>
#import <T1Twitter/T1NewsCameraPlacesFetcherDelegate-Protocol.h>
#import <T1Twitter/T1NewsCameraServiceAuthorizationViewControllerDelegate-Protocol.h>
#import <T1Twitter/T1NewsCameraWelcomeViewControllerDelegate-Protocol.h>
#import <T1Twitter/T1TweetOutboxViewControllerDelegate-Protocol.h>
...
@interface T1NewsCameraCaptureViewController : TFNViewController <PTVTwitterCameraCommonDelegate, T1NewsCameraAccountGeoDataProviderUpdaterDelegate, T1NewsCameraEventHashtagsFetcherDelegate, T1NewsCameraModeSelectorViewControllerDelegate, T1NewsCameraOutboxControlButtonViewControllerDelegate, T1NewsCameraPlacesFetcherDelegate, T1NewsCameraServiceAuthorizationViewControllerDelegate, T1NewsCameraWelcomeViewControllerDelegate, T1TweetOutboxViewControllerDelegate, TFNSwappingContainerViewControllerHelperDelegate, TFNTooltipDelegate, UIGestureRecognizerDelegate, T1DashNewsCameraPresented>
{
    ...
    _Bool _beingPresentedByDashNewsCameraPresenter;
    ...
    T1NewsCameraCapturePresentation *_currentCapturePresentation;
    ...
    T1NewsCameraOutboxControlButtonViewController *_outboxControlButtonViewController;
    UILayoutGuide *_cameraButtonsLayoutGuide;
    NSLayoutConstraint *_cameraButtonsLayoutGuideTrailingAnchorConstraint;
    NSLayoutConstraint *_cameraButtonsLayoutGuideWithOutboxButtonViewTrailingAnchorConstraint;
    ...
    T1NewsCameraModeSelectorViewController *_modeSelectorViewController;
    T1NewsCameraServiceAuthorizationViewController *_serviceAuthorizationViewController;
    T1NewsCameraWelcomeViewController *_welcomeViewController;
    T1NewsCameraAccountGeoDataProviderUpdater *_accountGeoDataProviderUpdater;
    T1NewsCameraPlacesFetcher *_placesFetcher;
    T1NewsCameraFetchResult *_currentPlacesFetchResult;
    T1NewsCameraEventHashtagsFetcher *_eventHashtagsFetcher;
    T1NewsCameraFetchResult *_currentEventHashtagsFetchResult;
}

+ (_Bool)canPresentWithAccount:(id)arg1 traitCollection:(id)arg2;
...
@property(retain, nonatomic) T1NewsCameraEventHashtagsFetcher *eventHashtagsFetcher; // @synthesize eventHashtagsFetcher=_eventHashtagsFetcher;
...
@property(retain, nonatomic) T1NewsCameraPlacesFetcher *placesFetcher; // @synthesize placesFetcher=_placesFetcher;
@property(retain, nonatomic) T1NewsCameraAccountGeoDataProviderUpdater *accountGeoDataProviderUpdater; // @synthesize accountGeoDataProviderUpdater=_accountGeoDataProviderUpdater;
@property(retain, nonatomic) T1NewsCameraWelcomeViewController *welcomeViewController; // @synthesize welcomeViewController=_welcomeViewController;
@property(retain, nonatomic) T1NewsCameraServiceAuthorizationViewController *serviceAuthorizationViewController; // @synthesize serviceAuthorizationViewController=_serviceAuthorizationViewController;
@property(retain, nonatomic) T1NewsCameraModeSelectorViewController *modeSelectorViewController; // @synthesize modeSelectorViewController=_modeSelectorViewController;
...
@property(retain, nonatomic) NSLayoutConstraint *cameraButtonsLayoutGuideWithOutboxButtonViewTrailingAnchorConstraint; // @synthesize cameraButtonsLayoutGuideWithOutboxButtonViewTrailingAnchorConstraint=_cameraButtonsLayoutGuideWithOutboxButtonViewTrailingAnchorConstraint;
...
@property(retain, nonatomic) T1NewsCameraOutboxControlButtonViewController *outboxControlButtonViewController; // @synthesize outboxControlButtonViewController=_outboxControlButtonViewController;
...
@property(nonatomic) _Bool needsToPresentOutboxViewController; // @synthesize needsToPresentOutboxViewController=_needsToPresentOutboxViewController;
@property(nonatomic, getter=isBeingPresentedByDashNewsCameraPresenter) _Bool beingPresentedByDashNewsCameraPresenter; // @synthesize beingPresentedByDashNewsCameraPresenter=_beingPresentedByDashNewsCameraPresenter;
...
@property(retain, nonatomic) T1NewsCameraCapturePresentation *currentCapturePresentation; // @synthesize currentCapturePresentation=_currentCapturePresentation;
...
@property(nonatomic) __weak id <T1NewsCameraCaptureViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)newsCameraPlacesFetcher:(id)arg1 didFetchCurrentPlaces:(id)arg2 error:(id)arg3;
- (void)_t1_main_updateEventHashtags;
- (void)_t1_main_updatePlaces;
- (void)newsCameraAccountGeoDataProviderUpdater:(id)arg1 didUpdateCurrentLocation:(id)arg2 error:(id)arg3;
- (void)_t1_main_dismissOutboxViewController:(id)arg1;
- (void)tweetOutboxViewControllerDidTapClose:(id)arg1;
- (void)tweetOutboxViewControllerDidUpdateWithoutItems:(id)arg1;
- (void)_t1_main_presentOutboxViewControllerAnimated:(_Bool)arg1;
- (void)newsCameraOutboxControlButtonViewControllerDidTapButton:(id)arg1;
- (void)newsCameraOutboxControlButtonViewController:(id)arg1 didChangeButtonState:(unsigned long long)arg2;
- (void)_t1_main_updateModeWithIndex:(unsigned long long)arg1;
- (void)newsCameraModeSelectorViewController:(id)arg1 didSelectModeAtIndex:(unsigned long long)arg2;
- (void)newsCameraModeSelectorViewController:(id)arg1 willSelectModeAtIndex:(unsigned long long)arg2;
...
- (void)newsCameraWelcomeViewControllerDidTapButton:(id)arg1;
- (void)newsCameraWelcomeViewControllerDidTapDismiss:(id)arg1;
- (void)_t1_main_updateAuthorizationState;
- (void)newsCameraServiceAuthorizationViewController:(id)arg1 didChangeAuthorizationState:(unsigned long long)arg2;
- (void)newsCameraServiceAuthorizationViewControllerDidTapDismiss:(id)arg1;
...
- (void)dashNewsCameraPresenterDidDismissViewController:(id)arg1;
- (void)dashNewsCameraPresenterDidPresentViewController:(id)arg1;
- (void)dashNewsCameraPresenterWillPresentViewController:(id)arg1;
- (void)viewControllerDidDismissAnimated:(_Bool)arg1;
- (void)_t1_main_viewControllerDidPresentedAnimated:(_Bool)arg1;
...
- (void)_t1_main_updateWelcomeViewNeedsToPresent;
- (void)_t1_main_updateWelcomeViewAnimated:(_Bool)arg1;
- (void)_t1_main_loadWelcomeViewControllerWithConstraints:(id)arg1;
...
- (void)_t1_main_updateOutboxControlButtonWithAnimationOptions:(unsigned long long)arg1;
- (void)_t1_main_updateOutboxControlButtonViewController;
- (void)_t1_main_loadOutboxControllerButtonViewControllerWithConstraints:(id)arg1;
...
- (void)_t1_main_disposeAudioSessionModeToken;
- (void)_t1_main_createAudioSessionModeToken;
...
- (void)_t1_main_updateNewsCameraMoments;
