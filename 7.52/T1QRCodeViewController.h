...
@class CAShapeLayer, NSMutableArray, NSString, T1AvatarImageView, TFNTwitterAccount, TwitterQRCodeView, UIImage, UILongPressGestureRecognizer, UITapGestureRecognizer;
...
@property(readonly, nonatomic) TwitterQRCodeView *qrCardView; // @synthesize qrCardView=_qrCardView;
