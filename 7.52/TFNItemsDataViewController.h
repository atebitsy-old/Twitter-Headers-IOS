...
@interface TFNItemsDataViewController : TFNDataViewController <TFNItemsDataViewDelegate, TFNItemsDataViewAssociation, TFNItemsAnimatorDelegate>
{
    ...
    NSMutableDictionary *_enqueuedPrefetchOperations;
...
- (void)cancelPrefetchingForItem:(id)arg1 atIndexPath:(id)arg2;
- (void)_tfn_cancelPrefetchingItemAtIndexPath:(id)arg1;
- (void)_tfn_cancelPrefetchingItemsAtIndexPaths:(id)arg1;
- (id)prefetchOperationsForItem:(id)arg1 atIndexPath:(id)arg2;
- (void)_tfn_prefetchItemsAtIndexPaths:(id)arg1;
