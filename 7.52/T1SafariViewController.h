...
@class NSString, NSURL, T1ViewControllerScribeEventObserver, T1WebViewLogger, T1WebViewRedirectTracker, TFNTwitterAccount, TFNTwitterStatus, UIScreenEdgePanGestureRecognizer;
