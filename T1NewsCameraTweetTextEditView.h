...
@class NSString, NSTextContainer, NSTextStorage, T1ComposeRTLTextViewDelegate, T1NewsCameraTweetTextView, T1TextViewAutocompleteController, TFNTwitterSearchTypeaheadStore, TFSMainThreadRunLoopDeferredTask, UIColor, UIFont, UIPanGestureRecognizer;
