...
@class T1LiveEventMediaViewController, TFNTwitterBroadcast, TFNTwitterStatus, TFSTwitterScribeContext, UIImage;
...
- (void)liveEventMediaContainerViewController:(T1LiveEventMediaViewController *)arg1 didTapExpandMediaForBroadcast:(TFNTwitterBroadcast *)arg2 cardDataSource:(id <TFNTwitterCardDataSource>)arg3;
