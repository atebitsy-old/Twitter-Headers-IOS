...
@class NSDate, NSString, NSURL, T1VideoBitRateManager, TAVAudioSessionModeToken, TAVPlaybackState, TAVPlayer, TAVScribeContext, TFNTwitterAccount, TFNTwitterBroadcast, TFNTwitterLiveEvent;
@protocol T1WatchBroadcastExternalVideoPlayerDelegate, TFNTwitterCardDataSource;

@interface T1WatchBroadcastExternalVideoPlayer : PTVExternalVideoPlayer <TAVPlaybackObserver, T1VideoBitRateManagerDelegate, T1BroadcastContainerViewDelegate, PTVBroadcastWatcherObserver, PTVGuestWatchingMainPlayer>
{
...
- (void)setTargetRelativePresentationOffset:(double)arg1;
...
- (void)_t1_audioSessionInterruptionNotification:(id)arg1;
- (void)_t1_dispose;
