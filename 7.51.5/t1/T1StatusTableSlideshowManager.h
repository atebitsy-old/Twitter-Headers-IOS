...
@protocol T1AutoplayFullscreenCoordinator;
...
- (id)presentSlideshowFromDataCell:(id)arg1 statusView:(id)arg2 slideIndexInCell:(unsigned long long)arg3 previewing:(_Bool)arg4 disableStatusActions:(_Bool)arg5;
