...
+ (void)createSharedHostViewControllerForAppDelegate:(id)arg1 fromSelector:(SEL)arg2 appNavigationProviderFactory:(id)arg3 signedOutViewControllerFactory:(id)arg4;
...
- (id)appNavigation;
- (id)currentAccount;
- (void)_useViewController:(id)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
