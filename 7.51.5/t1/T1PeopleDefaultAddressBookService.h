...
#import <T1Twitter/_TtP9T1Twitter24PeopleAddressBookService_-Protocol.h>

@class T1PeopleAddressBookAccessController;

@interface T1PeopleDefaultAddressBookService : NSObject <_TtP9T1Twitter24PeopleAddressBookService_>
{
