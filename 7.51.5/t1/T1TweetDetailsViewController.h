...
@protocol T1TweetDetailsViewControllerDelegate;

@interface T1TweetDetailsViewController : TFNItemsDataViewController <TFNTooltipDelegate, T1PersistentComposeViewControllerDelegate, T1ComposeCustomAction, T1ComposeViewControllerDelegate, T1SlideshowBuilder, T1TweetDetailsTweetBodyItemsDelegate, T1ImageTransitionDelegate, T1TwitterAuthenticated, T1DisplayTweetTranslationDelegate, T1ErrorDataViewAdapterDelegate, T1VideoMonetizationSettingsViewControllerDelegate, T1URTConversationTimelineObserver, T1URTTimelineTombstoneItemViewModelDelegate, T1DataViewControllerRenderPerformanceLoggerDataSource, T1NewsCameraImageTransitionDataSource, T1FeedbackActionProvider, T1JumpBackToHomeTimelineBehavior, TFNLayoutMetricsEnvironment, T1SpotlightUserActivityInfoProvider, T1SlideshowViewControllerDelegate>
{
    ...
    id _firstBodyItem;
    id _lastBodyItem;
    T1TweetDetailsActionView *_tweetDetailsActionView;
...
@property(readonly, nonatomic) T1TweetDetailsActionView *tweetDetailsActionView; // @synthesize tweetDetailsActionView=_tweetDetailsActionView;
...
- (void)_t1_conversationMuteDidUpdate:(id)arg1;
...
- (void)_t1_configureActivitySummaryView:(id)arg1;
...
- (void)updateStatusNavigationContext:(id)arg1;
- (void)viewDidLoad;
...
- (void)_t1_addReplyControllerToViewControllerHierarchy:(_Bool)arg1;
- (_Bool)_t1_isReplyBarVisible;
- (void)_t1_hideReplyBar:(_Bool)arg1;
- (void)_t1_displayReplyBar:(_Bool)arg1;
...
- (void)showInlineReply:(_Bool)arg1;
...
- (void)_t1_setNeedsUpdateUponUpdatingExperimentFlagsFromAccountIfNeeded;
...
- (_Bool)_t1_shouldShowHiddenRepliesTooltip;
- (void)_t1_triggerHiddenRepliesTooltip;
...
- (void)_t1_initializeHiddenRepliesTooltip;
