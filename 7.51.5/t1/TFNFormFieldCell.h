...
@class CAShapeLayer, NSString, TFNFormField, TFNFormFieldErrorView, TFNFormFieldSupplementaryTextView, TFNFormMultiLineTextField, TFNFormTextField, TFNTextTooltipContentView, TFNTooltip, UIButton, UIImageView, UITapGestureRecognizer, UIView;
