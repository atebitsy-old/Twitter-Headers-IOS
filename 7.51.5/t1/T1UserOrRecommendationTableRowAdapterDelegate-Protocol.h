...
- (void)userRowAdapter:(T1UserOrRecommendationTableRowAdapter *)arg1 user:(TFSTwitterUserReference *)arg2 didPerformAction:(unsigned long long)arg3 success:(_Bool)arg4 error:(NSError *)arg5;
