...
@interface T1PhotoGalleryCollectionsViewController : TFNViewController <UITableViewDataSource, UITableViewDelegate, PHPhotoLibraryChangeObserver, TFNModalSheetViewControllerDelegate, TFNModalSheetViewControllerLayoutDelegate>
{
    _Bool _dismissing;
