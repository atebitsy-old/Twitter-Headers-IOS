...
@class NSString, T1UserView, TFNTappableHighlightView, TFNTwitterAccount, TFNTwitterUnifiedCard, TIPImagePipeline, UIView;
...
@interface T1UnifiedCardProfileComponentView : TFNLayoutableView <T1UnifiedCardComponentView>
{
    ...
    id <TFNTwitterUnifiedCardComponentModel> component;
...
+ (id)_t1_adjustedMetricsFor:(id)arg1;
...
@property(retain, nonatomic) id <TFNTwitterUnifiedCardComponentModel> component; // @synthesize component;
