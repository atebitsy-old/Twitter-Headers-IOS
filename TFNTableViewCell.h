...
@class CALayer, CAShapeLayer, NSIndexPath, NSString, TFNDataViewCellLayout, TFNPrefetchingViewCache, UIColor, UIImageView, UITableView, UIView;
...
- (void)_updateSeparatorForPreviousVisibleCell:(id)arg1;
