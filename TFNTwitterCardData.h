...
@class NSDictionary, NSNumber, NSSet, NSString, TAVAnalyticsMediaIdentifier, TFNTwitterCardImageSpec, TFNTwitterPromotedContent, TFNTwitterUnifiedCard, TFNTwitterUser;

@interface TFNTwitterCardData : NSObject <TFNUIDesignableAppDetails, TFNUIDesignableConversationCardViewModel, TFNUIDesignableCardViewModel, NSCoding, NSCopying, TFSPlistSerialization>
{
...
+ (_Bool)_isAudioCardTypeFromCardType:(long long)arg1;
...
- (id)convertingUCCarouselsToUseFullBleed:(_Bool)arg1;
