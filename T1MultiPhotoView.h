...
+ (struct CGSize)preferredSizeForWidth:(double)arg1 mediaInfos:(id)arg2 primaryMediaInfo:(id)arg3 mediaParameters:(id)arg4 attachmentType:(unsigned long long)arg5 options:(unsigned long long)arg6;
