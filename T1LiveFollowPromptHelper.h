...
@protocol T1TwitterAuthenticated, TFNTwitterUserContext;

@interface T1LiveFollowPromptHelper : NSObject
{
    _Bool _hasLiveFollowPermission;
    TFNItemsDataViewController<T1TwitterAuthenticated> *_controller;
...
@property(retain, nonatomic) TFNItemsDataViewController<T1TwitterAuthenticated> *controller; // @synthesize controller=_controller;
...
- (id)initWithTargetUserDataSource:(id)arg1 userContext:(id)arg2 controller:(id)arg3 scribeContext:(id)arg4 userScribeItem:(id)arg5;
