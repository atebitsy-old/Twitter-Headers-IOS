...
@class NSArray, NSDate, NSString, T1ScrollingSegmentedViewController, TFNBarButtonItem, TFNExpandingButtonItem, TFNTwitterAccount;

@interface T1NotificationsViewController : TFNViewController <TFNTooltipDelegate, T1ScrollingSegmentedViewControllerDataSource, T1ScrollingSegmentedViewControllerDelegate, T1URTNotificationTimelineRefresherDelegate, T1PanelRootViewController>
{
    NSDate *_lastViewed;
