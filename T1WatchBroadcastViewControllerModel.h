...
@class NSString, NSURL, PTVExternalVideoAccessManager, PTVFastImageCacheUtilities, T1PeriscopeAccount, TFNTwitterAccount, TFNTwitterBroadcast, TFNTwitterLiveEvent, TFNTwitterStatus, TFNTwitterUser;
...
- (_Bool)isCopyrightViolationMatchingEnabled;
